...
//       try {
//         const response = await axios.post('https://localhost:7273/api/Signup', {
//           name: user.name,
//           email: user.email,
//           password: password,
//           mobile: 9090909090,
...
//       }
    ...
    const handleSuccess = async (ResponseCredential) => {
            ...
            // const response = await axios.post(`https://localhost:7273/api/Login/GetDetails?email=${email}`,
            // );
    ...
    return (
        <div>
            <GoogleOAuthProvider clientId="684298910357-2nbje25q3k0pkmmolkqd58lot0bu5ogj.apps.googleusercontent.com">
                <GoogleLogin
                 text="continue_with"
