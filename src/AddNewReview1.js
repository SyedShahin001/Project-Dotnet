//user review page to add a review and sending email
...
function AddNewReview1() {
  ...
  const fetchAppList = () => {
    fetch("https://localhost:7177/api/App/GetAllApps", {
      method: "GET",
      headers: {
  ...
  function handleSubmit(event) {
    ...
    fetch("https://localhost:7177/api/Review/AddReview", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    const templateParams = {
      ...
      to_email:email,
      to_name: "email",
      message:"Hii, Your reviews was sucessfully submitted",
    };
...
//user review page to add reviews